...
export const manifests: readonly PluginManifest[] = [
  ...
  },
  {
    ...
    category: "core-companion", runtime: "shared-adapter-host", runtimeEntry: { entry: "./src/worker.ts", protocol: "0.1" }, capabilities: ["config", "gateway", "events"], routes: [{ path: "/", methods: ["GET", "HEAD"] }, { path: "/health", methods: ["GET", "HEAD"] }],
    ui: { entry: "./ui/index.html", vehicleSupported: true }
  }
];
